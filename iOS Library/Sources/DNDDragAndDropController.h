 ...
 *               Default when using -init is [[UIApplication sharedApplication] keyWindow].
 */
 ...
 *
 * The returned view is removed from the current superview and added to the view
 * acting as the dragging container. If nil is returned, the dragging operation
 * is canceled.
 *
